<div class="accordion-item">
    ...
    <div id="section-bahagian_ii" class="accordion-collapse collapse" data-bs-parent="#evaluationAccordion">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="activities-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <input type="text" name="activities[{{ $index }}][description]" 
                                            class="form-control" value="{{ $activity['description'] ?? '' }}" required>
                                    </td>
                                    <td>
                                        <input type="text" name="activities[{{ $index }}][level]" 
                                            class="form-control" value="{{ $activity['level'] ?? '' }}" required>
                                    </td>
                                    <td>
                        ...
                        <div class="table-responsive">
                            <table class="table" id="trainings-table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="trainings[{{ $index }}][name]" 
                                                class="form-control" value="{{ $training['name'] ?? '' }}" required>
                                        </td>
                                        <td>
                                            <input type="text" name="trainings[{{ $index }}][date]" 
                                                class="form-control" value="{{ $training['date'] ?? '' }}" required>
                                        </td>
                                        <td>
                                            <input type="text" name="trainings[{{ $index }}][place]" 
                                                class="form-control" value="{{ $training['place'] ?? '' }}" required>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-danger remove-row">
                                                <i class="fas fa-trash"></i>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="table-responsive">
                            <table class="table" id="required-trainings-table">
                                ...
                                <tbody>
                                    @foreach(old('required_trainings', []) as $index => $training)
                                    <tr>
                                        <td>
                                            <input type="text" name="required_trainings[{{ $index }}][name]" 
                                                class="form-control" value="{{ $training['name'] ?? '' }}" required>
                                        </td>
                                        <td>
                                            <input type="text" name="required_trainings[{{ $index }}][reason]" 
                                                class="form-control" value="{{ $training['reason'] ?? '' }}" required>
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-sm btn-danger remove-row">
                                                <i class="fas fa-trash"></i>
...
<script>
    ...
    $('#add-activity').click(function() {
        const rowCount = $('#activities-table tbody tr').length;
        $('#activities-table tbody').append(`
            <tr>
                <td><input type="text" name="activities[${rowCount}][description]" class="form-control" required></td>
                <td><input type="text" name="activities[${rowCount}][level]" class="form-control" required></td>
    ...
    $('#add-training').click(function() {
        const rowCount = $('#trainings-table tbody tr').length;
        $('#trainings-table tbody').append(`
            <tr>
                <td><input type="text" name="trainings[${rowCount}][name]" class="form-control" required></td>
                <td><input type="text" name="trainings[${rowCount}][date]" class="form-control" required></td>
                <td><input type="text" name="trainings[${rowCount}][place]" class="form-control" required></td>
                <td><button type="button" class="btn btn-sm btn-danger remove-row"><i class="fas fa-trash"></i></button></td>
            </tr>
        `);
    });
    ...
    $('#add-required-training').click(function() {
        const rowCount = $('#required-trainings-table tbody tr').length;
        $('#required-trainings-table tbody').append(`
            <tr>
                <td><input type="text" name="required_trainings[${rowCount}][name]" class="form-control" required></td>
                <td><input type="text" name="required_trainings[${rowCount}][reason]" class="form-control" required></td>
                <td><button type="button" class="btn btn-sm btn-danger remove-row"><i class="fas fa-trash"></i></button></td>
            </tr>
        `);
    });
